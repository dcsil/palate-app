...
import 'resview_model.dart';
export 'resview_model.dart';

class ResviewWidget extends StatefulWidget {
  const ResviewWidget({super.key});

  @override
  State<ResviewWidget> createState() => _ResviewWidgetState();
}

class _ResviewWidgetState extends State<ResviewWidget>
    with TickerProviderStateMixin {
  late ResviewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ResviewModel());
