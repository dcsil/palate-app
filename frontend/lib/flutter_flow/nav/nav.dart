...
GoRouter createRouter(AppStateNotifier appStateNotifier) {
  ...
  return GoRouter(
    ...
    routes: [
      ...
      FFRoute(
        name: OnboardQuestionsWidget.routeName,
        path: OnboardQuestionsWidget.routePath,
        builder: (context, params) => OnboardQuestionsWidget(),
      ),
      FFRoute(
      ...
      FFRoute(
        ...
        builder: (context, params) => params.isEmpty
            ? NavBarPage(initialPage: 'recommendations')
            : RecommendationsWidget(),
      ),
      FFRoute(
        name: OnboardQuestions2Widget.routeName,
        path: OnboardQuestions2Widget.routePath,
        builder: (context, params) => OnboardQuestions2Widget(),
      ),
      FFRoute(
        name: OnboardQuestions3Widget.routeName,
        path: OnboardQuestions3Widget.routePath,
        builder: (context, params) => OnboardQuestions3Widget(),
      ),
      FFRoute(
